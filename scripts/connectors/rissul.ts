...
const CONFIG = {
  ...
  region: "Porto Alegre",
  source: "vtex:rissul",
  regionId: "v2.D0A056BF2DB4704DC95A61F703F4E27A",
  pageSize: 50,
  baseUrl:
    "https://www.rissul.com.br/api/catalog_system/pub/products/search",
  departments: [
    { id: 1, name: "Hortifruti" },
    { id: 2, name: "Congelados" },
    { id: 3, name: "Pets" },
    { id: 4, name: "Floricultura" },
    { id: 5, name: "Bazar" },
    { id: 6, name: "Higiene E Beleza" },
    { id: 7, name: "Mercearia" },
    { id: 8, name: "Carnes Aves E Peixes" },
    { id: 9, name: "Padaria E Rotisseria" },
    { id: 10, name: "Frios e Laticínios" },
    { id: 11, name: "Bebidas" },
    { id: 12, name: "Limpeza" },
  ],
} as const;
...
async function main() {
  console.log("");
  console.log("=================================");
  console.log(" BARATORADAR — RISSUL");
  console.log("=================================");
...
const to = from + CONFIG.pageSize - 1;
  ...
  console.log("");
  console.log("=================================");
  console.log(" RISSUL — CARGA CONCLUÍDA");
  console.log("=================================");
...
main().catch((error) => {
  console.error("");
  console.error("ERRO NO CONNECTOR RISSUL");
  console.error(error);
  process.exit(1);
});