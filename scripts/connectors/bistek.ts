...
const CONFIG = {
  ...
  pageSize: 50,
  baseUrl:
    "https://www.bistek.com.br/api/catalog_system/pub/products/search",
} as const;
...
async function main() {
  console.log("");
  console.log("=================================");
  console.log(" BARATORADAR — BISTEK");
  console.log("=================================");
...
if ((created + updated) % 50 === 0) {
  ...
  console.log("");
  console.log("=================================");
  console.log(" BISTEK — CARGA CONCLUÍDA");
  console.log("=================================");
...
main().catch((error) => {
  console.error("");
  console.error("ERRO NO CONNECTOR BISTEK");
  console.error(error);
  process.exit(1);
});