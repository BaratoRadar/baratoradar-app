...
const CONFIG = {
  ...
  region: "São Paulo",
  source: "vtex:mambo",
  regionId: "v2.B032579D3A36A563BE9985A52457C9DD",
  pageSize: 50,
  baseUrl:
    "https://www.mambo.com.br/api/catalog_system/pub/products/search",

  departments: [
    { id: 1590, name: "Adega" },
    { id: 1591, name: "Bazar e Utensílios" },
    { id: 1592, name: "Bebidas" },
    { id: 1593, name: "Carnes e Aves" },
    { id: 1594, name: "Congelados e Sobremesas" },
    { id: 1595, name: "Frios e Laticínios" },
    { id: 1596, name: "Higiene e Perfumaria" },
    { id: 1597, name: "Hortifrúti" },
    { id: 1598, name: "Limpeza" },
    { id: 1599, name: "Mercearia" },
    { id: 1600, name: "Padaria" },
    { id: 1601, name: "Pescados" },
    { id: 1602, name: "Petshop" },
    { id: 2167, name: "Churrasco" },
    { id: 2168, name: "Momento Mambo" },
    { id: 2169, name: "Saúde e Bem-Estar" },
  ],
} as const;
...
async function fetchPage(
  ...
  url.searchParams.set("fq", `C:/1589/${departmentId}/`);
...
const to = from + CONFIG.pageSize - 1;
  ...
  console.log("");
  console.log("=================================");
  console.log(" MAMBO — CARGA CONCLUÍDA");
  console.log("=================================");
...
main().catch((error) => {
  console.error("");
  console.error("ERRO NO CONNECTOR MAMBO");
  console.error(error);
  process.exit(1);
});